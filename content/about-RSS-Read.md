...
有一些针对具体的社会化媒体生成 RSS 的服务，但或者收费，或者稳定性欠佳失效，或者收费且稳定性欠佳失效（我就订阅了一个微信公众号的 RSS 服务，没用多久就失效了还不退款），想了下，就不在这里列举了，感兴趣可以直接在<https://morerss.com/tools_zh.html查找。>
...
在浏览器中访问服务器ip:端口号（如<http://123.45.67.890:8080），如显示登录界面，即代表安装成功。域名解析和反代步骤略。>
